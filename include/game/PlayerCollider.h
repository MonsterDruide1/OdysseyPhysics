...
public:
    ...
    void calcResultVecArrow(sead::BitFlag<uint> *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,CollidedShapeResult const*);
    void calcResultVecSphere(sead::BitFlag<uint> *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,CollidedShapeResult const*);
    void calcResultVecDisk(sead::BitFlag<uint> *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,sead::Vector3f *,CollidedShapeResult const*);
...
private:
    ...
    int pad;
    CollisionMultiShapeSimple *mCollisionMultiShape;
