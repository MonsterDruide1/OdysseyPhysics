...
void sead::CalculateTask::pauseDraw(bool) {CRASH}
void sead::CalculateTask::pauseCalcRec(bool) {CRASH}
void sead::CalculateTask::pauseDrawRec(bool) {CRASH}
void sead::CalculateTask::pauseCalcChild(bool) {CRASH}
void sead::CalculateTask::pauseDrawChild(bool) {CRASH}
void sead::CalculateTask::attachCalcImpl() {CRASH}
void sead::CalculateTask::attachDrawImpl() {CRASH}
void sead::CalculateTask::detachCalcImpl() {CRASH}
void sead::CalculateTask::detachDrawImpl() {CRASH}
const sead::RuntimeTypeInfo::Interface* sead::CalculateTask::getCorrespondingMethodTreeMgrTypeInfo() const {CRASH}
sead::MethodTreeNode* sead::CalculateTask::getMethodTreeNode(int) {CRASH}

sead::TaskBase::TaskBase(sead::TaskConstructArg const&, char const*) {CRASH}
sead::TaskBase::TaskBase(sead::TaskConstructArg const&) {CRASH}
sead::TaskBase::~TaskBase() {CRASH}
void sead::TaskBase::prepare() {CRASH}
void sead::TaskBase::enterCommon() {CRASH}
void sead::TaskBase::enter() {CRASH}
void sead::TaskBase::exit() {CRASH}
void sead::TaskBase::onEvent(sead::TaskEvent const&) {CRASH}
void sead::TaskBase::onDestroy() {CRASH}
void sead::TaskBase::pauseCalcChild(bool) {CRASH}
void sead::TaskBase::pauseDrawChild(bool) {CRASH}
