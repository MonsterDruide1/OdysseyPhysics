...
bool checkHitSegmentCylinder(sead::Vector3<float> const&, float, sead::Vector3<float> const&, float, sead::Vector3<float> const&, sead::Vector3<float> const&, sead::Vector3<float>*, sead::Vector3<float>*) {return false;}
