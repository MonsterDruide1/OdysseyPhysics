...
bool isMsgBossMagmaCatchPlayer(al::SensorMsg const*) {return false;}
bool isMsgBossMagmaDeadDemoEnd(al::SensorMsg const*) {return false;}
bool isMsgBossMagmaDeadDemoStart(al::SensorMsg const*) {return false;}
bool isMsgBossMagmaQueryToBubble(al::SensorMsg const*) {return false;}
bool isMsgBossMagmaReleasePlayer(al::SensorMsg const*) {return false;}
bool isMsgBubbleAttack(al::SensorMsg const*) {return false;}
bool isMsgBubbleLauncherStart(al::SensorMsg const*) {return false;}
bool isMsgEndInSaucePan(al::SensorMsg const*) {return false;}
bool isMsgEnemyAttackFireCollision(al::SensorMsg const*) {return false;}
bool isMsgFireDamageAll(al::SensorMsg const*) {return false;}
bool isMsgHackDirectStageInit(IUsePlayerHack**, al::SensorMsg const*) {return false;}
bool isMsgHackInvalidEscape(al::SensorMsg const*) {return false;}
bool isMsgHackInvalidEscapeNoReaction(al::SensorMsg const*) {return false;}
bool isMsgHammerBrosHammerEnemyAttack(al::SensorMsg const*) {return false;}
bool isMsgKillByMoonRockDemo(al::SensorMsg const*) {return false;}
bool isMsgHosuiTrample(al::SensorMsg const*) {return false;}
bool isMsgPlayerBallToss(al::SensorMsg const*) {return false;}
bool isMsgUpperPunchAll(al::SensorMsg const*) {return false;}
bool isMsgHosuiTrampleReflect(al::SensorMsg const*) {return false;}
...
bool sendMsgEventFlowScareCheck(al::HitSensor*, al::HitSensor*, al::EventFlowExecutor*) {return false;}

void sendPlayerCollisionTouchMsg(al::LiveActor const*, al::HitSensor*, IUsePlayerCollision const*) {}

bool checkMsgNpcTrampleReactionAll(al::SensorMsg const*, al::HitSensor const*, al::HitSensor const*, bool) {return false;}
