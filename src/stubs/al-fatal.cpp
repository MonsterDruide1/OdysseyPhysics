...
void al::ModelKeeper::update() {CRASH}
void al::ModelKeeper::updateLast() {CRASH}
void al::EffectKeeper::update() {CRASH}
void al::HitSensorKeeper::update() {CRASH}
void al::ActorActionKeeper::updatePost() {CRASH}
void al::ScreenPointKeeper::update() {CRASH}
void alScreenPointFunction::updateScreenPointAll(al::LiveActor*) {CRASH}
void alSensorFunction::updateHitSensorsAll(al::LiveActor*) {CRASH}
void alSensorFunction::clearHitSensors(al::LiveActor*) {CRASH}
...
void al::ActionSeCtrl::startAction(char const*) {CRASH}
void al::ActionBgmCtrl::startAction(char const*) {CRASH}
void al::ActionPadAndCameraCtrl::startAction(char const*) {CRASH}
void al::ActionScreenEffectCtrl::startAction(char const*) {CRASH}
bool al::ActionAnimCtrl::start(char const*) {CRASH}
void al::ActionEffectCtrl::startAction(char const*) {CRASH}

al::ActionEffectCtrl* al::ActionEffectCtrl::tryCreate(al::IUseEffectKeeper*) {CRASH}
al::ActionBgmCtrl* al::ActionBgmCtrl::tryCreate(al::AudioKeeper*) {CRASH}
al::ActionScreenEffectCtrl* al::ActionScreenEffectCtrl::tryCreate(al::LiveActor const*, char const*) {CRASH}
al::ActionAnimCtrl* al::ActionAnimCtrl::tryCreate(al::LiveActor*, al::ActorResource const*, char const*, char const*) {CRASH}
al::ActionPadAndCameraCtrl* al::ActionPadAndCameraCtrl::tryCreate(al::LiveActor const*, al::ActorResource const*, sead::Vector3<float> const*, char const*) {CRASH}
al::ActionSeCtrl* al::ActionSeCtrl::tryCreate(al::AudioKeeper*) {CRASH}

void al::SeKeeper::resetPosition() {CRASH}
void al::HitSensorKeeper::attackSensor() {CRASH}
void al::updateMaterialCodePuddle(al::LiveActor*) {CRASH}
void al::setMaterialCode(al::LiveActor*, char const*) {CRASH}
const char* al::getCollidedFloorMaterialCodeName(al::LiveActor const*) {CRASH}

bool al::isExistModelResourceYaml(al::LiveActor const*, char const*, char const*) {CRASH}
void al::createFileNameBySuffix(sead::BufferedSafeStringBase<char>*, char const*, char const*) {CRASH}
bool al::isExistModelResource(al::LiveActor const*) {CRASH}
const char* al::createStringIfInStack(char const*) {CRASH}
bool al::tryGetActorInitFileName(sead::BufferedSafeStringBase<char>*, al::LiveActor const*, char const*, char const*) {CRASH}
