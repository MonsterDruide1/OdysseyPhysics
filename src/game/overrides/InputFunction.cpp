...
s32 getPlayerControllerPort(s32 playerNo) {
    ...
    sead::Controller* controller =
        manager->getControllerByOrder(sead::ControllerDefine::ControllerId::cController_Npad, playerNo);
...
s32 getTouchPanelPort() {
    auto* manager = sead::ControllerMgr::instance();
    sead::Controller* controller =
        manager->getControllerByOrder(sead::ControllerDefine::ControllerId::cController_PadTouch, 0);
    return manager->findControllerPort(controller);
}
