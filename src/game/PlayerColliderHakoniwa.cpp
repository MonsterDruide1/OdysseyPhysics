...
PlayerColliderHakoniwa::PlayerColliderHakoniwa(RaylibActor* actor, const PlayerConst* c, al::CollisionDirector* collisionDirector) : mPlayer(actor), mPlayerConst(c) {
